...
class Install extends CI_Controller {
	...
	protected function create_environmen()
	{
		$content = "<?php define('ENVIRONMENT', isset(\$_SERVER['CI_ENV']) ? \$_SERVER['CI_ENV'] : 'development');";
		$file = FCPATH."environment.php";
		fopen($file, "w");
		write_file($file, $content);
	}
}