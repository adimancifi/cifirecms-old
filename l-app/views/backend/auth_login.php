...
<div class="auth-container mg-t-50">
	...
	<div class="card auth-box">
		...
		<div class="form-group">
			...
			<input id="username" type="text" name="<?=$input_uname;?>" class="form-control input-username" maxlength="20" required>
		</div>
		<div class="form-group">
			<label><?=lang_line('password');?></label>
			<input type="password" name="<?=$input_pwd?>" id="password" class="form-control" maxlength="20" required>
		</div>
