			...
			<div class="box-body">
				<div class="table-responsive">
					<table class="table table-striped table-hover mb-0">
						<?=$content_other;?>
						<tr>
							<td class="tx-medium" width="150">ENVIRONMENT</td>
							<td>
								<select id="setEnvironment" class="form-control" style="width:200px;">
									<option value="<?=ENVIRONMENT?>" style="display:none;"><?=ENVIRONMENT?></option>
